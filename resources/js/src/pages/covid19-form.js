			...
			grecaptcha.ready(function() {
				grecaptcha.execute('6LcW7ZYUAAAAAJqH2HgvLFroSHpBBv5xgNoP5MZD', {action: 'button_submit_help_form'}).then(function(token) {
					const formData = {
						...
						// RLR
						RLR_1: $('#RLR-1-center').val(),
						RLR_2: $('#RLR-2-center-directorName').val(),
						RLR_3: $('#RLR-3-center-directorEmail').val(),
						...
						RLR_10: $('#RLR-10-grants').val(),
						RLR_11: $('#RLR-11-building').val(),
						RLR_12: $('#RLR-12-rooms').val(),
						RLR_13: $('#RLR-13-shared').val(),
						RLR_14: $('#RLR-14-sharedFunction').val(),
						RLR_15: $('#RLR-15-equipmentChecks').val(),
						RLR_16: $('#RLR-16-equipmentStatus').val(),
						RLR_17: $('#RLR-17-equipmentSupply').val(),
						RLR_18: $('#RLR-18-equipmentResupply').val(),
						RLR_19: $('#RLR-19-ppeSupply').val(),
						RLR_20: $('#RLR-20-ppeResupply').val(),
						RLR_21: $('#RLR-21-cleaningSupply').val(),
						RLR_22: $('#RLR-22-cleaningResupply').val(),
						RLR_23: $('#RLR-23-core').val(),
						RLR_24: $('#RLR-24-coreUse').val(),
						RLR_25: $('#RLR-25-animalUse').val(),
						RLR_26: $('#RLR-26-animalTimeline').val(),
						RLR_27: $('#RLR-27-animalOrder').val(),
						RLR_28: $('#RLR-28-animalHousing').val(),

						// LRSD
						LRSD_1: $('#LRSD-1-projects').val(),
						LRSD_2: $('#LRSD-2-rationale').val(),
						LRSD_3: $('#LRSD-3-distancing').val(),
						LRSD_4: $('#LRSD-4-hygiene').val(),
						LRSD_5: $('#LRSD-5-staffing').val(),
						LRSD_6: $('#LRSD-6-cleaning').val(),
						LRSD_7: $('#LRSD-7-other').val(),
						LRSD_8: $('#LRSD-8-rampdown').val()
					...
					$.ajax(
						{
							url: '/api/v1/cherwell/ticket/create/one/covid19',
							method: 'POST',
							data: {
								token,
								formData

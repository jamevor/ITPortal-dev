...
/**
 * Custom Header block for the Editor.js.
 *
...
function () {
  ...
  function Header(_ref) {
    ...
    config.minHeader = config.minHeader || 1;
    config.maxHeader = config.maxHeader || 6;
    config.defaultLevel = config.defaultLevel || 1;
  ...
  _createClass(Header, [{
    ...
    value: function onPaste(event) {
      ...
      var level = this._settings.defaultLevel;
    ...
    get: function get() {
      ...
      var defaultLevelIndex = this.levels.findIndex(function (v) {
        return v.number === _this4._settings.defaultLevel;
      });
      return defaultLevelIndex !== -1 ? this.levels[defaultLevelIndex] : this.levels[0];
    }
    /**
    ...
    get: function get() {
      ...
      }].slice(this._settings.minHeader - 1, this._settings.maxHeader);
    }
  }], [{
    key: "pasteConfig",
    get: function get() {
